...
function Footer() {
  return (
    <footer className="fixed bottom-0 left-0 z-20 w-full p-4 bg-white border-t border-gray-200 shadow md:flex md:items-center md:justify-between md:p-6 ">
      <ul className="flex flex-wrap items-center m-auto mt-3 text-sm text-gray-500  sm:mt-0">
        <li>
          <a href="/Prices" className="hover:underline md:mr-6">
            Current supermarket price of eggs: $0.96 each.
          </a>
        </li>
        <li>
          <a href="/Prices" className="mr-4 hover:underline md:mr-6">
