  ...
  return (
    <div>
      ...
      <form className="bg-gray-50 shadow-xl w-3/4 mx-auto p-10 mb-20 rounded-lg">
        ...
        <div>
          <div className="text-center col-span-full mb-4">
            <h2 className="text-xl font-bold underline mb-4">Cost to House</h2>
          ...
          <div>
            <div className="text-center col-span-full mb-4">
              <h2 className="text-xl font-bold underline mb-4">Other Costs</h2>
              <p>
          ...
          <p className="mb-5">
            ...
            account time/effort involved in looking after hens such as cleaning,
            feeding, refilling water.
          </p>
        </div>
        <button
          type="submit"
